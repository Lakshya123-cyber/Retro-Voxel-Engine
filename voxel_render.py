...
height_map_img = pg.image.load("imgs/height_map.jpeg")
height_map = pg.surfarray.array3d(height_map_img)

color_map_img = pg.image.load("imgs/color_map.jpeg")
            ...
            if 0 < x < map_width:
                ...
                if 0 < y < map_height:
                    ...
                    height_on_screen = int(
                        (player_height - height_map[x, y][0]) / depth * scale_height
                        + player_pitch
                    )
